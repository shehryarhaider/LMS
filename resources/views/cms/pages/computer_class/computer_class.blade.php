    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Computer Class</li>
        </ol>
      </div>
    </div>
    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Computer Class Page</h3>
      ...
      <div class="panel-collapse collapse show" style="">
        <div class="portlet-body">
          ...
          <!-- ComputerClass Header -->
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#ComputerClassHeader"></a>
              <h3 class="portlet-title">Computer Class Header</h3>
              <div class="portlet-widgets">
                <button id="IntroComputerClassHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="ComputerClassHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="ComputerClassHeading form-control" value="{{$intro_computer_class_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12"><br>
                    <div class="form-group custom_upload">
                      <label class="control-label">Attach</label>
                      <input {{$intro_computer_class_header->attachment ? 'required' : NULL}} id="ComputerAttachment" type="file" name="attachment" class="filestyle" data-iconname="fa fa-cloud-upload" data-parsley-errors-container="#error-file">
                      <div id="error-file"></div>
                      <span class="text-danger">{{$errors->first('attachment') ?? null}}</span><br>
                      @if($intro_computer_class_header->attachment)
                        <a href = "{{getConfig('files_link').$intro_computer_class_header->attachment}}" target="_blank" class="btn btn-white waves-effect btn-rounded">
                          <span class="btn-label">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1"
                href="#IntroComputerClassListCollapse"></a>
              <h3 class="portlet-title">Image Section List</h3>
              <div class="portlet-widgets">
                <a href="{{route('computer_class_image_section.create')}}" class="btn btn-white waves-effect btn-rounded">
                  <span class="btn-label">
            ...
            <div id="IntroComputerClassListCollapse" class="panel-collapse collapse ">
              <div class="portlet-body">
                <div class="custom_datatable">
                  <table id="BelowComputerClassIntroList" class="table table-bordered table-striped" width="100%" cellspacing="0"
                    cellpadding="0">
                    <thead>
                      <tr>
...
@include('cms.pages.computer_class.includes.computer-class-image-list')
@include('cms.pages.computer_class.includes.intro-computer-class-header')
@endsection
