...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    var table = $('#BelowFindingSurveyIntroList').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("findingsurvey_image_section.datatable") }}',
        "columns": [
        ...
        },
        {
          "targets": -1,
          "render": function (data, type, row, meta) {
            var edit = '{{route("findingsurvey_image_section.edit",":id")}}';
      ...
      "drawCallback":function(settings){
        ...
        $('.ImageSectionStatus').change(function(){
          ...
          axios
            .post('{{route("findingsurvey_image_section.status")}}',{
              _token: "_token",
              _method: "patch",
              id: id,
              status: status,
        ...
        $('.ImageSectionDelete').click(function () {
            ...
            swal({
              ...
              if (result.value) {
              axios
                .post('{{route("findingsurvey_image_section.destroy")}}', {
                  _method: 'delete',
                  _token: '{{csrf_token()}}',
                  id: deleteId,
                })
