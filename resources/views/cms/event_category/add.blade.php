...
<div class="content">
  <div class="container-fluid">
    ...
    <form action="{{$isEdit ? route('event_categories.update',[$event_categories->id]) : route('event_categories.store')}}" method="POST">
      @csrf
      @if ($isEdit)
      ...
      <div class="portlet">
        <div class="portlet-heading bg-light-theme">
          <h3 class="portlet-title">
            <span class="ti-user mr-2"></span>Add Event Category</h3>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Name
                      ...
                      <input type="text" name="name" parsley-trigger="change" required placeholder="Name..." class="form-control" id="userName" value="{{$event_categories->name ?? null }}" required>
