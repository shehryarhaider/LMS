    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Add Controller</li>
        </ol>

      </div>
    </div>

    <form action="{{route('vendor.mvc.controller.store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="portlet">
        <div class="portlet-heading bg-light-theme">
          <h3 class="portlet-title">
            <span class="ti-user mr-2"></span>Add Controller</h3>
          <div class="portlet-widgets">
            <a href="{{route('vendor.mvc.controller')}}">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="file" name="controller" parsley-trigger="change" required class="form-control" id="controller" multiple>
                    <span class="text-danger">{{$errors->first('controller')?? null}}</span>
                  </div>
                </div>
