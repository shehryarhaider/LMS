    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Mission Page</h3>
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="IntroMissionHeading form-control" value="{{$intro_mission_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroMissionText form-control summernote">{{$intro_mission_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.mission.includes.intro-mission-header')
@endsection
