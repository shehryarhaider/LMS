...
<div class="content">
  <div class="container-fluid">
    ...
    <form action="{{route('vendor.mvc.view.store')}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="portlet">
        <div class="portlet-heading bg-light-theme">
          <h3 class="portlet-title">
            <span class="ti-user mr-2"></span>Add View</h3>
          <div class="portlet-widgets">
            <a href="{{route('vendor.mvc.view')}}">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="file" name="view" parsley-trigger="change" required class="form-control" id="view" multiple>
                    <span class="text-danger">{{$errors->first('view')?? null}}</span>
                  </div>
                </div>
