    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Value Page</h3>
        ...
        <div class="portlet-body">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              ...
              <h3 class="portlet-title">Value Header</h3>
              <div class="portlet-widgets">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="IntroValueHeading form-control" value="{{$intro_value_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroValueText form-control summernote">{{$intro_value_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.values.includes.intro-value-header')
@endsection
