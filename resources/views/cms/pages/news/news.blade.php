    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>News Page</h3>
        ...
        <div class="portlet-body">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#NewsHeader"></a>
              <h3 class="portlet-title">News Header</h3>
              <div class="portlet-widgets">
                <button id="IntroNewsHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="NewsHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="IntroNewsHeading form-control" value="{{$intro_news_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroNewsText form-control summernote">{{$intro_news_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.news.includes.intro-news-header')
@endsection
