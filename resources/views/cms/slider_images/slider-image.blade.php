...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route("slider_image.datatable") }}',
      "columns": [
      ...
      @if ($count > 0)
      {
        "targets": -1,
        "render": function (data, type, row, meta) {
          var edit = '{{route("slider_image.edit",[":id"])}}';
      ...
      "drawCallback": function (settings) {
        ...
        $('.status').change(function () {
          ...
          axios
            .post('{{route("slider_image.status")}}', {
              _token: '{{csrf_token()}}',
              _method: 'patch',
              id: id,
              status: status,
        ...
        $('.delete').click(function () {
          ...
          swal({
            ...
            if (result.value) {
            axios
              .post('{{route("slider_image.destroy")}}', {
                _method: 'delete',
                _token: '{{csrf_token()}}',
                id: deleteId,
              })
