      ...
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-ite active">
            <a href="{{route('sub_committee',[Session::get("term_id")])}}">Sub Committee</a>
          </li>
        </ol>
      </div>
    </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route("sub_committee.datatable",[Session::get("term_id"),":id"]) }}',
      "columns": [
      ...
      @if ($count > 0)
      {
        "targets": -1,
        "render": function (data, type, row, meta) {
          var edit = '{{route("sub_committee.edit",[Session::get("term_id"),":id"])}}';
      ...
      "drawCallback": function (settings) {
        ...
        $('.status').change(function () {
          ...
          axios
            .post('{{route("sub_committee.status")}}', {
              _token: '{{csrf_token()}}',
              _method: 'patch',
              id: id,
              status: status,
        ...
        $('.delete').click(function () {
          ...
          swal({
            ...
            if (result.value) {
            axios
              .post('{{route("sub_committee.destroy")}}', {
                _method: 'delete',
                _token: '{{csrf_token()}}',
                id: deleteId,
              })
