...
<div class="content">
  <div class="container-fluid">
    ...
    <form action="{{$isEdit ? route('our_service.update',[$our_service->id]) : route('our_service.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @if ($isEdit)
                ...
                <div class="row">
                    ...
                    <div class="avatar-upload">
                      ...
                      <div class="avatar-preview">
                        <div id="imagePreview1"
                          style="background-image : url({{getConfig('files_link')}}{{$our_service->icon ?? 'placeholder.jpg'}}">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required
                        class="form-control" value="{{$our_service->text ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="form-control summernote">{{$our_service->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
