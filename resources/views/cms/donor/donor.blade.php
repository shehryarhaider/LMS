    ...
    <div class="portlet">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <i class="ti-user mr-2"></i> Donor</h3>
        <div class="portlet-widgets">
          ...
          <a href="{{route('donor.create')}}">
            <button class="btn btn-white btn-custom-white btn-custom btn-rounded waves-effect" type="button">
              <i class="fa fa-plus"></i> Add Donor</button>
          </a>
          @endif
        </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    //   e.preventDefault();
    //   table.columns(1).search($('select[name="category"]').val());
    //   table.columns(2).search($('input[name="heading"]').val());
    //   table.columns(3).search($('input[name="text"]').val());
    //   table.draw();
    // });
