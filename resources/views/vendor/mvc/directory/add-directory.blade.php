...
<div class="content">
  <div class="container-fluid">
    ...
    <form action="{{route('vendor.mvc.directory.store',[$mvc])}}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="portlet">
        <div class="portlet-heading bg-light-theme">
          <h3 class="portlet-title">
            <span class="ti-user mr-2"></span>Add directory</h3>
          <div class="portlet-widgets">
            <a href="{{route('vendor.mvc.directory',[$mvc])}}">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="directory" parsley-trigger="change" required class="form-control" id="directory" >
                    <span class="text-danger">{{$errors->first('directory')?? null}}</span>
                  </div>
                </div>
