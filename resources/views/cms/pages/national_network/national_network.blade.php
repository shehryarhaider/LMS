...
@section('title', 'National Network')
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">National Network</li>
        </ol>
      </div>
    </div>
    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>National Network Page</h3>
      ...
      <div class="panel-collapse collapse show" style="">
        <div class="portlet-body">
          ...
          <!-- National Network Header -->
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#NationalNetworkHeader"></a>
              <h3 class="portlet-title">National Network Header</h3>
              <div class="portlet-widgets">
                <button id="IntroNationalNetworkHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="NationalNetworkHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="IntroNationalNetworkHeading form-control" value="{{$intro_natioanlNetwork_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroNationalNetworkText form-control summernote">{{$intro_natioanlNetwork_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.national_network.includes.intro-national-network-header')
@endsection
