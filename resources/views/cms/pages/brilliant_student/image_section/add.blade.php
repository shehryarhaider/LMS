...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{route('padeaf.brilliant_students')}}">Brilliant Student</a>
          </li>
    ...
    <form action="{{$isEdit ? route('BS_image_section.update',[$BS_image_section->id]) : route('BS_image_section.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @if ($isEdit)
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required class="IntroMissionText form-control" value="{{$BS_image_section->heading ?? null }}">
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="form-control summernote">{{$BS_image_section->text ?? null }}</textarea>
                    </div>
