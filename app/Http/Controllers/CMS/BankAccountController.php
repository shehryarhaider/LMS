...
class BankAccountController extends Controller
{
    ...
    public function datatable()
    {
        ...
        $roles = DB::table('bank_accounts')->select(['id','bank_type_id','account_code','account_name','account_title','bank_name','branch','contact_person','telephone','mobile','email','address','remarks','website','fax', 'status']);
