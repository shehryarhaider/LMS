    ...
    <div class="portlet">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <i class="ti-harddrives mr-2"></i> Model Files</h3>
        <div class="portlet-widgets">
          <span class="divider"></span>
          <a href="{{route('vendor.mvc.model.create')}}" class="btn btn-white btn-custom btn-custom-white btn-rounded waves-effect">
            <i class="fa fa-save mr-1"></i> Add Model</a>
        </div>
  ...
  $(document).ready(function () {
    ...
    $(document).on('click', '.delete', function () {
      ...
      swal({
        ...
        if (result.value) {
          axios
            .post('{{route("vendor.mvc.model.destroy")}}', {
              _method: 'delete',
              _token: '{{csrf_token()}}',
              name: deleteName,
            })
