...
@section('title', 'Sign Language Interpreter Class')
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sign Language Interpreter Class</li>
        </ol>
      </div>
    </div>
    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Sign Language Interpreter Class Page</h3>
      ...
      <div class="panel-collapse collapse show" style="">
        <div class="portlet-body">
          ...
          <!-- Sign Language Interpreter Class Header -->
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#SilClassHeader"></a>
              <h3 class="portlet-title">Sign Language Interpreter Class Header</h3>
              <div class="portlet-widgets">
                <button id="IntroSilClassHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="SilClassHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="SilClassHeading form-control" value="{{$intro_Sil_class_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12"><br>
                    <div class="form-group custom_upload">
                      <label class="control-label">Attach</label>
                      <input {{$intro_Sil_class_header->attachment ? 'required' : NULL}} id="SilAttachment" type="file" name="attachment" class="filestyle" data-iconname="fa fa-cloud-upload" data-parsley-errors-container="#error-file">
                      <div id="error-file"></div>
                      <span class="text-danger">{{$errors->first('attachment') ?? null}}</span><br>
                      @if($intro_Sil_class_header->attachment)
                        <a href = "{{getConfig('files_link').$intro_Sil_class_header->attachment}}" target="_blank" class="btn btn-white waves-effect btn-rounded">
                          <span class="btn-label">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required class="SilClassText  form-control summernote">{{$intro_Sil_class_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.sign_language_class.includes.intro-sign-language-class-header')
@endsection
