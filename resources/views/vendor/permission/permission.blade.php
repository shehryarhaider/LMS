    ...
    <div class="portlet">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <i class="ti-sharethis mr-2"></i> Permission</h3>
        <div class="portlet-widgets">
          <a href="{{route('vendor.permission.create')}}">
      ...
      <div id="bg-primary1" class="panel-collapse collapse show">
        <div class="portlet-body">
          <div class="alert alert-danger text-center">
              ...
              Incorrect Deleting/Editing of permission's will result in a broken application, proceed with caution !
          </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{ route("vendor.permission.datatable") }}',
      "columns": [
        { "data": "", "defaultContent": "" },
        { "data": "menus.name", "defaultContent": "" },
...

      {
        "targets": -1,
        "render": function (data, type, row, meta) {
          var edit = '{{route("vendor.permission.edit",[":id"])}}';
      ...
      "drawCallback": function (settings) {
        ...
        $('.delete').click(function () {
          ...
          swal({
            ...
            if (result.value) {
            axios
              .post('{{route("vendor.permission.destroy")}}', {
                _method: 'delete',
                _token: '{{csrf_token()}}',
                id: deleteId,
              })
