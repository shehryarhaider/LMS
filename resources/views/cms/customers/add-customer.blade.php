              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select parsley-trigger="change" data-style="btn-white" name="customer_type" class="form-control">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="account_name" parsley-trigger="change" required placeholder="Name..." class="form-control" id="userName" value="{{$customer->name ?? null }}">
