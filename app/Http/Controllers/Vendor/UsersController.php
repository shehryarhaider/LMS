...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vendor.users.users', $data);
    }
    ...
    public function datatable()
    {
        ...
        $users = User::with(['role'=>function($query){
                            ...
                            }])->select(['um_users.id','um_users.name','email','role_id','status'])->where('user_type', 2);
    ...
    public function create()
    {
        ...
        return view('vendor.users.add-user', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.users');
    }
    ...
    public function settings()
    {
        ...
        return view('vendor.users.settings', $data);
    }
