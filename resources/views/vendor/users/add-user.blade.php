...
<div class="content">
  <div class="container-fluid">
    ...
    <form action="{{$isEdit ? route('vendor.users.update', [$user->id]) : route('vendor.users.store')}}" method="post"
                  ...
                  <div class="form-group">
                    ...
                    <select parsley-trigger="change" required="" data-style="btn-white" name="role_id" class="form-control"
                      ...
                      <option value="{{$item->id}}"
                        {{ old('role_id') && old('role_id') == $item->id ? 'selected' : $isEdit && $user->role_id == $item->id ? 'selected' : null}}>{{ $item->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
