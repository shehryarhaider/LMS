    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Cooking Class</li>
        </ol>
      </div>
    </div>
    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Cooking Class Page</h3>
        ...
        <div class="portlet-body">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#CookingClassHeader"></a>
              <h3 class="portlet-title">Cooking Class Header</h3>
              <div class="portlet-widgets">
                <button id="IntroCookingClassHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="CookingClassHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="CookingClassHeading form-control" value="{{$intro_cooking_class_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="avatar-upload">
                      ...
                      <div class="avatar-preview">
                        <div id="imagePreview1" style="background-image : url({{getConfig('files_link')}}{{$intro_cooking_class_header->icon ?? 'placeholder.jpg'}});">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12"><br>
                    <div class="form-group custom_upload">
                      ...
                      <input id="CookingAttachment" type="file" name="attachment" class="filestyle" data-iconname="fa fa-cloud-upload" data-parsley-errors-container="#error-file">
                      <div id="error-file"></div>
                      <span class="text-danger">{{$errors->first('attachment') ?? null}}</span><br>
                      @if($intro_cooking_class_header->attachment)
                        <a href = "{{getConfig('files_link').$intro_cooking_class_header->attachment ?? Null}}" target="_blank" class="btn btn-white waves-effect btn-rounded">
                          <span class="btn-label">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required class="CookingClassText  form-control summernote">{{$intro_cooking_class_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.cooking_class.includes.intro-cooking-class-header')
@endsection
