    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Project Page</h3>
        ...
        <div class="portlet-body">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#ValueHeader"></a>
              <h3 class="portlet-title">Project Header</h3>
              <div class="portlet-widgets">
                <button id="IntroValueHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="ValueHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="IntroValueHeading form-control" value="{{$project_value_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroValueText form-control summernote">{{$project_value_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
...
@include('cms.pages.projects.includes.project-value-header')
@endsection
