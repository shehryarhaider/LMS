...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{route('padeaf.computer_class')}}">Computer Class</a>
          </li>
    ...
    <form action="{{$isEdit ? route('computer_class_image_section.update',[$computer_class_image_section->id]) : route('computer_class_image_section.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @if ($isEdit)
                ...
                <div class="col-md-12">
                    <div class="avatar-upload">
                      ...
                      <div class="avatar-preview">
                        <div id="imagePreview1" style="background-image : url({{getConfig('files_link')}}{{$computer_class_image_section->icon ?? 'placeholder.jpg'}});">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="form-control summernote">{{$computer_class_image_section->text ?? null }}</textarea>
                    </div>
