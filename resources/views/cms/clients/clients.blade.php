    ...
    <div class="portlet">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <i class="fa fa-id-card mr-2"></i> Clients</h3>
        <div class="portlet-widgets">
          @if ( $permissions == "is_admin" || in_array( 'import', $permissions ) )
          <a href="{{route('import.clients')}}">
            <button class="btn btn-white btn-custom-white btn-custom btn-rounded waves-effect" type="button">
              <i class="fa fa-plus"></i>Import Clients</button>
          </a>
          @endif
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="number"  class="form-control" placeholder="Number" autocomplete="off" />
                    </div>
                  </div>
                  <div class="col-md-8">
                  </div>
  ...
  $(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
      ...
      @if ($count > 0)
      {
        "targets": -1,
        "render": function (data, type, row, meta) {
          var edit = '{{route("clients.edit",[":id"])}}';
    ...
    $('#advanceSearch').submit(function(e){
      ...
      table.columns(3).search($('input[name="number"]').val());
      table.draw();
    });
