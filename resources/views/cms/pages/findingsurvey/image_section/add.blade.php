...
<div class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="{{route('padeaf.finding_survey_report')}}">Finding Survey</a>
          </li>
    ...
    <form action="{{$isEdit ? route('findingsurvey_image_section.update',[$findingsurvey_image_section->id]) : route('findingsurvey_image_section.store')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @if ($isEdit)
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required class="IntroMissionText form-control" value="{{$findingsurvey_image_section->heading ?? null }}">
                    </div>
                    ...
                    <div class="avatar-upload">
                      ...
                      <div class="avatar-preview">
                        <div id="imagePreview1"
                          style="background-image : url({{getConfig('files_link')}}{{$findingsurvey_image_section->icon ?? 'placeholder.jpg'}}">
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="text" parsley-trigger="change" required
                        class="IntroMissionText form-control">{{$findingsurvey_image_section->text ?? null }}</textarea>
                    </div>
