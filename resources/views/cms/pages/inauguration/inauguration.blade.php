    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Inauguration</li>
        </ol>
      </div>
    </div>
    ...
    <div class="portlet m-b-0">
      <div class="portlet-heading bg-light-theme">
        <h3 class="portlet-title">
          <span class="ti-pencil-alt mr-2"></span>Inauguration Page</h3>
        ...
        <div class="portlet-body">
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1" href="#InaugurationHeader"></a>
              <h3 class="portlet-title">Inauguration Header</h3>
              <div class="portlet-widgets">
                <button id="IntroInaugurationHeader" class="btn btn-white waves-effect btn-rounded">
            ...
            <div id="InaugurationHeader" class="panel-collapse collapse">
              <div class="portlet-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="heading" parsley-trigger="change" required placeholder="Heading..."
                        class="InaugurationHeading form-control" value="{{$intro_inauguration_header->heading ?? null }}">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea type="text" name="below_heading" parsley-trigger="change" required class="InaugurationBelowHeading form-control summernote">{{$intro_inauguration_header->text ?? null }}</textarea>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="portlet">
            <div class="portlet-heading bg-dark-theme">
              <a class="link_b toggle" data-toggle="collapse" data-parent="#accordion1"
                href="#IntroInaugurationListCollapse"></a>
            ...
            <div id="IntroInaugurationListCollapse" class="panel-collapse collapse ">
              <div class="portlet-body">
                <div class="custom_datatable">
                  <table id="BelowInaugurationIntroList" class="table table-bordered table-striped" width="100%" cellspacing="0"
                    cellpadding="0">
                    <thead>
                      <tr>
...
@include('cms.pages.inauguration.includes.inauguration-image-list')
@include('cms.pages.inauguration.includes.intro-inauguration-header')
@endsection
